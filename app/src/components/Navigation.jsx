      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <button onClick={() => handleNavClick('programs')} className="text-gray-700 hover:text-blue-600 transition">Programs</button>
            <button onClick={() => handleNavClick('about')} className="text-gray-700 hover:text-blue-600 transition">About</button>
            <button onClick={() => handleNavClick('contact')} className="text-gray-700 hover:text-blue-600 transition">Contact</button>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden pb-4">
            ...
            <button onClick={() => handleNavClick('programs')} className="block w-full text-left py-2 text-gray-700 hover:text-blue-600">Programs</button>
            <button onClick={() => handleNavClick('about')} className="block w-full text-left py-2 text-gray-700 hover:text-blue-600">About</button>
            <button onClick={() => handleNavClick('contact')} className="block w-full text-left py-2 text-gray-700 hover:text-blue-600">Contact</button>
          </div>
        )}
      </div>
    </nav>
